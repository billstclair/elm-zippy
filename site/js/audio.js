function startAudio(app)
{
    ...
    if (!(app.ports.audioPortFromJS && app.ports.audioPortToJS)) {
        if (!app.ports.audioPortFromJS && !app.ports.audioPortToJS) {
            console.log("Your all is missing both ports: audioPortFromJS & audioPortToJs");
        } else if (!app.ports.audioPortFromJS) {
            console.log("Your app is missing port: audioPortFromJS");
        } else {
            console.log("Your app is missing port: audioPortToJS");
        }
    }
    else
    {
